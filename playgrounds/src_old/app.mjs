...
export default function App() {
  ...
  const sidebarItems = [
    ...
    { id: "layout", label: "Layout", icon: "columns-layout" },
    ...
    { isHeader: true, label: "Rich Components" },
    {
      ...
      isExpanded: true,
      children: [
        { id: "components-text", label: "Text", icon: "text" },
        { id: "components-icon", label: "Icon", icon: "star" },
        { id: "components-button", label: "Button", icon: "button" },
        { id: "components-card", label: "Card", icon: "window" },
        { id: "components-badge", label: "Badge", icon: "tag", badge: { value: "New", tone: "dimmed", variant: "solid" } },
        { id: "components-searchbox", label: "Search Box", icon: "search" },
        { id: "components-checkbox", label: "Check Box", icon: "check" },
        { id: "components-input", label: "Input Field", icon: "pencil" },
        {
        ...
        { id: "components-grid", label: "Grid", icon: "grid" },
        { id: "components-table", label: "Table", icon: "table" },
        { id: "components-codeblock", label: "Code Block", icon: "terminal" },
        {
        ...
        { id: "components-dialog", label: "Dialog", icon: "window" },
      ],
    },
  ];
