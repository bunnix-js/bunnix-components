...
export const framework7IconsSourceCount = 1253;

export const framework7IconsIntro = [
  "Framework7 Icons v5.0.5 official package snapshot.",
  "This local catalog is generated from the downloaded official cheatsheet and uses the same ligature names as the shipped Framework7 icon font.",
];
...
export const framework7IconsAttribution = [
  ...
  "LICENSE: MIT License",
  "AUTHOR: framework7io",
  "SOURCE: Official local cheatsheet snapshot",
